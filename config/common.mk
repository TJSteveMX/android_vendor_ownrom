...
# Terminal Emulator
PRODUCT_COPY_FILES +=  \
    vendor/ownrom/proprietary/Term.apk:system/app/Term/Term.apk \
    vendor/ownrom/proprietary/lib/armeabi/libjackpal-androidterm4.so:system/app/Term/lib/arm/libjackpal-androidterm4.so
...
# release
ifeq ($(RELEASE),true)
	OwnROM_VERSION := $(OWNROM_VERSION_MAJOR).$(OWNROM_VERSION_MINOR)-Alpha
else
